...
class FirStaticScope(val delegateTypeScope: FirScope) : FirScope() {
    override fun processClassifiersByName(
        name: Name,
        processor: (FirClassifierSymbol<*>) -> Unit
    ) {
        delegateTypeScope.processClassifiersByName(name) {
    ...
    override fun processFunctionsByName(
        ...
        delegateTypeScope.processFunctionsByName(name) {
