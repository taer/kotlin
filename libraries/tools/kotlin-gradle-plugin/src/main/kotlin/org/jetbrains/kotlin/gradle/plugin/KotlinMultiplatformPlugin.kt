...
private const val KOTLIN_12X_MPP_DEPRECATION_IGNORE_FLAG = "kotlin.internal.mpp12x.deprecation.suppress"

private fun warnAboutKotlin12xMppDeprecation(project: Project) {
    if (project.findProperty(KOTLIN_12X_MPP_DEPRECATION_IGNORE_FLAG) != "true") {
